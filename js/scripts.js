$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Gloria and Agustin's Wedding",

            // Event start date
            start: new Date('Feb 26, 2022 5:30'),
            ...
            // Event Address
            address: 'The Heights Villa',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Agustin Morales at +1 5129632095."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Just a sec!</strong> We are saving your details.'));
            $.post('https://script.google.com/macros/s/AKfycbyPvu5HSp6wl1BbSNPgM4fr9dHcYR9zXpAe7t_oH4lNurOfXLdntUSZGBqzu6L-_9Ok/exec', data)
                .done(function (data) {
                    console.log(data);
